...
public class RangedCharacter extends Character
{
	...
	private Image archerLeft = new Image("Pictures/lisa_range/lisa_range_left.gif");
	private ImagePattern archerLeftP = new ImagePattern(archerLeft);
	private Image archerRight = new Image("Pictures/lisa_range/lisa_range_right.gif");
	private ImagePattern archerRightP = new ImagePattern(archerRight);
	
	private Image archerAttackRight = new Image("Pictures/lisa_range/lisa_attack_right.gif");
	private ImagePattern archerAttackRightP = new ImagePattern(archerAttackRight);
	private Image archerAttackLeft = new Image("Pictures/lisa_range/lisa_attack_left.gif");
	private ImagePattern archerAttackLeftP = new ImagePattern(archerAttackLeft);
	
	private Image archerStillLeft = new Image("Pictures/lisa_range/lisa_range_left_still.png");
	private ImagePattern archerStillLeftP = new ImagePattern(archerStillLeft);
	private Image archerStillRight = new Image("Pictures/lisa_range/lisa_range_right_still.png");
	private ImagePattern archerStillRightP = new ImagePattern(archerStillRight);
    
	private Image bulletRight = new Image("Pictures/lisa_range/arrow_right.png");
    private ImagePattern bulletRightP = new ImagePattern(bulletRight);
    private Image bulletLeft = new Image("Pictures/lisa_range/arrow_left.png");
