...
public class NPC extends Character
{
	...
	//METAMAN TEXTURES
	private Image metaManLeft = new Image("Pictures/metaman/metaman_left.gif");
    private ImagePattern metaManLeftP = new ImagePattern(metaManLeft);
    private Image metaManRight = new Image("Pictures/metaman/metaman_right.gif");
    private ImagePattern metaManRightP = new ImagePattern(metaManRight);
    private Image metaManAttackLeft = new Image("Pictures/metaman/metaman_attack_left.gif");
    private ImagePattern metaManAttackLeftP = new ImagePattern(metaManAttackLeft);
    private Image metaManAttackRight = new Image("Pictures/metaman/metaman_attack_right.gif");
    private ImagePattern metaManAttackRightP = new ImagePattern(metaManAttackRight);
    private Image metaManStillLeft = new Image("Pictures/metaman/metaman_left_still.png");
    private ImagePattern metaManStillLeftP = new ImagePattern(metaManLeft);
    private Image metaManStillRight = new Image("Pictures/metaman/metaman_right_still.png");
    private ImagePattern metaManStillRightP = new ImagePattern(metaManRight);
    
    //GUNSLINGER TEXTURES
    private Image gunslingerLeft = new Image("Pictures/gunslinger/gunslinger_left.gif");
    private ImagePattern gunslingerLeftP = new ImagePattern(gunslingerLeft);
    private Image gunslingerRight = new Image("Pictures/gunslinger/gunslinger_right.gif");
    private ImagePattern gunslingerRightP = new ImagePattern(gunslingerRight);
    private Image gunslingerStillLeft = new Image("Pictures/gunslinger/gunslinger_left_still.png");
    private ImagePattern gunslingerStillLeftP = new ImagePattern(gunslingerStillLeft);
    private Image gunslingerStillRight = new Image("Pictures/gunslinger/gunslinger_right_still.png");
    private ImagePattern gunslingerStillRightP = new ImagePattern(gunslingerStillRight);
    
    //POISON IVY TEXTURES
    private Image poisonIvyLeft = new Image("Pictures/poisonivy/poison_ivy_left.gif");
    private ImagePattern poisonIvyLeftP = new ImagePattern(poisonIvyLeft);
    private Image poisonIvyRight = new Image("Pictures/poisonivy/poison_ivy_right.gif");
    private ImagePattern poisonIvyRightP = new ImagePattern(poisonIvyRight);
    private Image poisonIvyAttackLeft = new Image("Pictures/poisonivy/poison_ivy_attack_left.gif");
    private ImagePattern poisonIvyAttackLeftP = new ImagePattern(poisonIvyAttackLeft);
    private Image poisonIvyAttackRight = new Image("Pictures/poisonivy/poison_ivy_attack_right.gif");
    private ImagePattern poisonIvyAttackRightP = new ImagePattern(poisonIvyAttackRight);
    private Image poisonIvyStillLeft = new Image("Pictures/poisonivy/poison_ivy_left_still.png");
    private ImagePattern poisonIvyStillLeftP = new ImagePattern(poisonIvyStillLeft);
    private Image poisonIvyStillRight = new Image("Pictures/poisonivy/poison_ivy_right_still.png");
    private ImagePattern poisonIvyStillRightP = new ImagePattern(poisonIvyStillRight);
    
    //PROJECTILES VVVVVVVVVVV
    private Image bulletRight = new Image("Pictures/gunslinger/right_bullet.png");
    private ImagePattern bulletRightP = new ImagePattern(bulletRight);
    private Image bulletLeft = new Image("Pictures/gunslinger/left_bullet.png");
    private ImagePattern bulletLeftP = new ImagePattern(bulletLeft);
    
    private Image poisonRight = new Image("Pictures/poisonivy/poison_right.gif");
    private ImagePattern poisonRightP = new ImagePattern(poisonRight);
    private Image poisonLeft = new Image("Pictures/poisonivy/poison_left.gif");
    private ImagePattern poisonLeftP = new ImagePattern(poisonLeft);
    
    private Image worm_right = new Image("Pictures/metaman/worm_right.gif");
    private ImagePattern wormRightP = new ImagePattern(worm_right);
    private Image worm_left = new Image("Pictures/metaman/worm_left.gif");
