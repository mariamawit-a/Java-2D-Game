...
public class GameEngine 
{
    ...
    private int levelNum = 1;
     ...
     public void winningScreen()
     {
         ...
         Image setting = new Image("Pictures/scene/jupiterScene.gif");
     ...
     private void btnListener() {
         ...
         startPane.getHTPButton().setOnMouseClicked(((event) -> 
         {
             ...
             Image setting = new Image("Pictures/menu/HowToPlay.png");
             ImagePattern settingP = new ImagePattern(setting);
         ...
         startPane.getCreditsButton().setOnMouseClicked((event) -> 
         {
        	 backgroundCredits.setWidth(primaryScreenBounds.getWidth());
             backgroundCredits.setHeight(primaryScreenBounds.getHeight());
             Image setting = new Image("Pictures/menu/AoJLoadingScreen.gif");
             ImagePattern settingP = new ImagePattern(setting);
             backgroundCredits.setFill(settingP);
             ...
             //creditPane.setAlignment(Pos.BOTTOM_CENTER);
	       	 Font CreditFont = new Font("Comic Sans MS", primaryScreenBounds.getHeight() * .02);
	       	 ...
	       	 names1.setLayoutY(primaryScreenBounds.getHeight() * 0.35);
         ...
         startPane.getQuitButton().setOnMouseClicked((event -> 
         {
             ...
             BackgroundImage imageBG = new BackgroundImage(new Image("Pictures/menu/AoJTerror.gif"),
     ...
     {	
    	 Image settingDay = new Image("Pictures/scene/back_day.gif");
    	 ImagePattern settingDayP = new ImagePattern(settingDay);
         
    	 Image settingRain = new Image("Pictures/scene/rain_back.gif");
    	 ImagePattern settingRainP = new ImagePattern(settingRain);
       
    	 Image settingNight = new Image("Pictures/scene/dark_ground_back.gif");
